...
PatientsUsermodel patientsUsermodelFromJson(String str) => PatientsUsermodel.fromJson(json.decode(str));

String patientsUsermodelToJson(PatientsUsermodel data) => json.encode(data.toJson());

class PatientsUsermodel {
  PatientsUsermodel({
    this.id,
    this.profile,
  ...
  factory PatientsUsermodel.fromJson(Map<String, dynamic> json) => PatientsUsermodel(
    id: json["id"],
